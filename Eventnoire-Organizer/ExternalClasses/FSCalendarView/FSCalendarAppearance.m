...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _titleFont = [UIFont fontWithName:@"OpenSans" size:FSCalendarStandardTitleTextSize];
        _subtitleFont = [UIFont fontWithName:@"OpenSans" size:FSCalendarStandardSubtitleTextSize];
        _weekdayFont = [UIFont fontWithName:@"OpenSans" size:FSCalendarStandardWeekdayTextSize];
        _headerTitleFont = [UIFont fontWithName:@"OpenSans" size:FSCalendarStandardHeaderTextSize];
