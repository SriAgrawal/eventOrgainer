...
-(void)showPickerSheetWithOptions:(NSArray *)options andCurrentSelectionIndex:(NSInteger)currentIndex AndComplitionblock:(OptionPickerSheetBlock)block
{
    [self endEditing:YES];
...
-(UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    [label setFont:[UIFont fontWithName:@"OpenSans" size:20.0]];
