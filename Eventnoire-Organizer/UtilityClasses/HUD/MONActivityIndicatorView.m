...
@interface MONActivityIndicatorView () <CAAnimationDelegate>
...
- (void)setupDefaults {
  ...
  self.delay = 0.1;
  self.duration = 0.3;
  // self.defaultColor = [UIColor colorWithRed:0.0/255.0 green:40.0/255.0 blue:48.0/255.0 alpha:1.0];
   // self.defaultColor = [UIColor redColor];
    self.defaultColor = [UIColor colorWithRed:72.0/255.0 green:176.0/255.0 blue:254.0/255.0 alpha:1.0];
}
...
- (CABasicAnimation *)createAnimationWithDuration:(CGFloat)duration delay:(CGFloat)delay {
  ...
  anim.delegate = self;
  anim.fromValue = [NSNumber numberWithFloat:0.4f];
